...
class SampleDevelopmentReport(models.AbstractModel):
    _name = 'report.commercial_invoice_arian.module_report'

    @api.model
    def render_html(self,docids, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('commercial_invoice_arian.module_report')
        ...
        return report_obj.render('commercial_invoice_arian.module_report', docargs)
